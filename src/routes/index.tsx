      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pb-20 md:pb-28 w-full">
        ...
        >
          <p className="text-base leading-relaxed">
            A women's atelier on Al Mazoon Street. Abayas, kaftans and evening silhouettes — cut,
            draped and finished by hand.
          </p>
      ...
      <div className="grid md:grid-cols-12 gap-10 items-start">
        ...
        <div className="md:col-span-9">
          <h2 className="font-display text-4xl md:text-6xl leading-[1.05] reveal">
            ...
            <span className="italic text-shimmer">a private language</span> — spoken in weight of
            cloth, line of shoulder, way of walking.
          </h2>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex items-end justify-between mb-16 reveal">
          ...
          <p className="hidden md:block text-sm text-muted-foreground max-w-xs">
            Twelve pieces. Each made in series of nine. Numbered, signed, and fitted in atelier.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-6 md:gap-10">
          {pieces.map((p, i) => (
            <article key={i} className="group reveal" style={{ transitionDelay: `${i * 150}ms` }}>
    ...
    <section id="atelier" className="relative py-32 md:py-44 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          >
            Off Al Mazoon Street, behind a slow brass door, the atelier holds three fittings an
            evening. Tea is brought. Lengths are measured twice. Nothing leaves until it sits
            exactly the way it should.
          </p>
          <div className="mt-10 grid grid-cols-2 gap-8 reveal" style={{ transitionDelay: "240ms" }}>
            <div>
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-10 grid md:grid-cols-2 gap-16">
        <div>
          <p className="text-xs tracking-[0.4em] uppercase opacity-60 mb-6 reveal">— Visit</p>
          ...
          <p
            ...
            style={{ transitionDelay: "120ms" }}
          >
            By appointment, or simply step in during opening hours. We will pour something cold and
            show you the new cloths.
          </p>
        ...
        <div className="reveal" style={{ transitionDelay: "180ms" }}>
          <div className="border border-primary-foreground/20 p-8 md:p-10">
            <p className="text-xs tracking-[0.4em] uppercase opacity-60 mb-6">— Opening Hours</p>
